...
Source0  : https://files.pythonhosted.org/packages/c4/ea/68b92be86543118140de6d8107acdf10c2c422759dcddbf1f50681abae0e/types-python-dateutil-2.8.19.5.tar.gz
...
%prep
%setup -q -n types-python-dateutil-2.8.19.5
cd %{_builddir}/types-python-dateutil-2.8.19.5
pushd ..
cp -a types-python-dateutil-2.8.19.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671479453
