...
Source0  : https://files.pythonhosted.org/packages/28/cd/2f094758ff9ee4ad820fc20b37e89908c0ff9fd541d066c1afa5a47acf2e/types-python-dateutil-2.8.16.tar.gz
...
%prep
%setup -q -n types-python-dateutil-2.8.16
cd %{_builddir}/types-python-dateutil-2.8.16
pushd ..
cp -a types-python-dateutil-2.8.16 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653009208
