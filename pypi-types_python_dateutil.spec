...
Source0  : https://files.pythonhosted.org/packages/30/bd/c9d7ae86e82f177101336b445cbf3e9c5ca9864a8bbe13e5601b3a1b91ad/types-python-dateutil-2.8.19.6.tar.gz
...
%prep
%setup -q -n types-python-dateutil-2.8.19.6
cd %{_builddir}/types-python-dateutil-2.8.19.6
pushd ..
cp -a types-python-dateutil-2.8.19.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674056959
