...
%prep
%setup -q -n types-python-dateutil-2.8.19
cd %{_builddir}/types-python-dateutil-2.8.19
pushd ..
cp -a types-python-dateutil-2.8.19 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1658241858
