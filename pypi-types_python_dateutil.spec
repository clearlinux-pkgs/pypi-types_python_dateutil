...
Source0  : https://files.pythonhosted.org/packages/ea/43/f675eb9c13cb784ee18f44b99a9ec5ee73aa4d1a6aff230699c7fc76ad03/types-python-dateutil-2.8.17.tar.gz
...
%prep
%setup -q -n types-python-dateutil-2.8.17
cd %{_builddir}/types-python-dateutil-2.8.17
pushd ..
cp -a types-python-dateutil-2.8.17 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653664103
