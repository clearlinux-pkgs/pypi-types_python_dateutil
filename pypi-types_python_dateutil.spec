...
Source0  : https://files.pythonhosted.org/packages/97/0b/01d3a541e9dfa3f9af1ff6266cd2b80902c251e4b0dc3ad52c6471549622/types-python-dateutil-2.8.19.9.tar.gz
...
%prep
%setup -q -n types-python-dateutil-2.8.19.9
cd %{_builddir}/types-python-dateutil-2.8.19.9
pushd ..
cp -a types-python-dateutil-2.8.19.9 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677516552
