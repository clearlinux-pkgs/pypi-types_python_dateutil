...
Source0  : https://files.pythonhosted.org/packages/03/d8/25283ad81a48d73bbd1d1fd0a0ee6106e6cdd2dda8534c062967e57c2e8b/types-python-dateutil-2.8.19.3.tar.gz
...
%prep
%setup -q -n types-python-dateutil-2.8.19.3
cd %{_builddir}/types-python-dateutil-2.8.19.3
pushd ..
cp -a types-python-dateutil-2.8.19.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667958297
