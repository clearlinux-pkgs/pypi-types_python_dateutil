...
Source0  : https://files.pythonhosted.org/packages/44/47/731b6a362f4e563af57972c2699df759191f39c5b49ed056b3dd065bc495/types-python-dateutil-2.8.18.tar.gz
...
%prep
%setup -q -n types-python-dateutil-2.8.18
cd %{_builddir}/types-python-dateutil-2.8.18
pushd ..
cp -a types-python-dateutil-2.8.18 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655911041
