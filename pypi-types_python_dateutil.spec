...
Source0  : https://files.pythonhosted.org/packages/c9/95/6bdde7607da2e1e99ec1c1672a759d42f26644bbacf939916e086db34870/types_python_dateutil-2.9.0.20250708.tar.gz
...
%prep
%setup -q -n types_python_dateutil-2.9.0.20250708
cd %{_builddir}/types_python_dateutil-2.9.0.20250708
pushd ..
cp -a types_python_dateutil-2.9.0.20250708 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1751983552
