...
Source0  : https://files.pythonhosted.org/packages/09/e3/cf963dc3054bdede941e11780a6968b99f100e81fafe7b01fa56e3fd6802/types-python-dateutil-2.8.19.2.tar.gz
...
%prep
%setup -q -n types-python-dateutil-2.8.19.2
cd %{_builddir}/types-python-dateutil-2.8.19.2
pushd ..
cp -a types-python-dateutil-2.8.19.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666020799
