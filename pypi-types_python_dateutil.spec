...
Source0  : https://files.pythonhosted.org/packages/ef/88/d65ed807393285204ab6e2801e5d11fbbea811adcaa979a2ed3b67a5ef41/types_python_dateutil-2.9.0.20250516.tar.gz
Summary  : Typing stubs for python-dateutil
Group    : Development/Tools
License  : Apache-2.0
Requires: pypi-types_python_dateutil-license = %{version}-%{release}
...
%package license
Summary: license components for the pypi-types_python_dateutil package.
Group: Default

%description license
license components for the pypi-types_python_dateutil package.
...
%prep
%setup -q -n types_python_dateutil-2.9.0.20250516
cd %{_builddir}/types_python_dateutil-2.9.0.20250516
pushd ..
cp -a types_python_dateutil-2.9.0.20250516 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747405816
...
export MAKEFLAGS=%{?_smp_mflags}
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/pypi-types_python_dateutil
cp %{_builddir}/types_python_dateutil-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-types_python_dateutil/dff786a9b9a95ffbea8a758f43143c45bc64cd66 || :
...
/usr/share/package-licenses/pypi-types_python_dateutil/dff786a9b9a95ffbea8a758f43143c45bc64cd66
