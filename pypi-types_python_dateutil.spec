...
Source0  : https://files.pythonhosted.org/packages/31/f8/f6ee4c803a7beccffee21bb29a71573b39f7037c224843eff53e5308c16e/types-python-dateutil-2.9.0.20241003.tar.gz
...
%prep
%setup -q -n types-python-dateutil-2.9.0.20241003
cd %{_builddir}/types-python-dateutil-2.9.0.20241003
pushd ..
cp -a types-python-dateutil-2.9.0.20241003 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727967550
