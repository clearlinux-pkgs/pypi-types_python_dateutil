...
Source0  : https://files.pythonhosted.org/packages/fb/90/e37d402a07f5a93791fc2837ee14b6947989aed6dc7895c420eb93354aea/types-python-dateutil-2.8.19.20240311.tar.gz
...
%prep
%setup -q -n types-python-dateutil-2.8.19.20240311
cd %{_builddir}/types-python-dateutil-2.8.19.20240311
pushd ..
cp -a types-python-dateutil-2.8.19.20240311 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710174196
